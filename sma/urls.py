...
urlpatterns = [
    ...
    path('calendario/agregar/', agregar_evento_temp, name='agregar_evento'),
    path('calendario/editar/<int:evento_id>/', editar_evento_temp, name='editar_evento'),
    path('calendario/eliminar/<int:evento_id>/', eliminar_evento_temp, name='eliminar_evento'),
